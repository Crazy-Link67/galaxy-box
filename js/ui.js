...
const CATEGORY_TOOLS = {
    destruction: [
        ...
        { id: 'dark_matter_implosion', name: 'Dark Matter Implosion', icon: '🌌', desc: 'Gravitational collapse ripping space into void and crushing armor.' },
        { id: 'antimatter_bomb', name: 'Antimatter Annihilator', icon: '⚛️', desc: 'Pure matter-antimatter reaction vaporizing wide terrain into nothingness.' },
        { id: 'singularity_cannon', name: 'Singularity Cannon', icon: '🕳️', desc: 'Fires high-velocity micro black hole gravitational pulses.' },
        { id: 'plasma_orbital_beam', name: 'Plasma Orbital Beam', icon: '🛰️', desc: 'Solar-focus satellite lance superheating earth to liquid magma.' },
        { id: 'gamma_ray_burst', name: 'Gamma Ray Burst', icon: '☢️', desc: 'Extreme cosmic radiation stream obliterating cellular structures.' },
        { id: 'chrono_rift', name: 'Chrono Rift Tear', icon: '⏳', desc: 'Ruptures time continuum, trapping hostile forces in temporal stasis.' },
        { id: 'dimension_collapse', name: 'Dimension Collapse', icon: '🌀', desc: 'Dimensional instability tearing local spacetime into cosmic corruption.' },
        { id: 'magnetic_storm', name: 'Magnetic EMP Storm', icon: '⚡', desc: 'Pulsing electromagnetic fields shorting shields and stunning units.' },
        { id: 'tachyon_blast', name: 'Tachyon Hyper-Blast', icon: '💫', desc: 'Faster-than-light particle lance piercing directly through all defenses.' },
        { id: 'solar_flare_strike', name: 'Solar Flare Strike', icon: '☀️', desc: 'Hurls concentrated solar coronal mass ejection incinerating kingdoms.' },
        { id: 'graviton_pulse', name: 'Graviton Pulse', icon: '💥', desc: 'Repulsor wave scattering colossal armies and blasting fortress walls.' },
        { id: 'nanite_plague', name: 'Nanite Swarm Plague', icon: '🦠', desc: 'Self-replicating microscopic machines consuming matter and converting to sludge.' },
        { id: 'supernova_spark', name: 'Supernova Spark', icon: '🌟', desc: 'Ignites stellar core fusion trigger unleashing cataclysmic thermal blast.' },
        { id: 'subzero_freeze_bomb', name: 'Subzero Cryo Bomb', icon: '❄️', desc: 'Liquid nitrogen shockwave instantly freezing oceans and living foes.' },
        { id: 'chaos_meteor_shower', name: 'Chaos Meteor Shower', icon: '☄️', desc: 'Bombardment of blazing cosmic asteroid fragments raining across world.' },
        { id: 'void_vortex', name: 'Void Singularity Vortex', icon: '🌪️', desc: 'Swirling gravitational sink pulling nearby terrain and entities inward.' },
        { id: 'inferno_barrage', name: 'Inferno Mortar Barrage', icon: '🔥', desc: 'Volleys of incendiary shells turning fertile biomes to blazing infernos.' },
        { id: 'acidic_deluge', name: 'Acidic Deluge Bomb', icon: '🧪', desc: 'Saturates surface with corrosive bubbling emerald acid pools.' },
        { id: 'cosmic_lightning_storm', name: 'Cosmic Lightning Surge', icon: '🌩️', desc: 'Cascading high-voltage celestial arcs striking multiple targets simultaneously.' },
        { id: 'abyssal_quake', name: 'Abyssal Chasm Quake', icon: '🌐', desc: 'Deep-mantle seismic shudder shattering bedrock and creating canyons.' },
        { id: 'radioactive_fallout_strike', name: 'Radioactive Fallout Strike', icon: '☢️', desc: 'Irradiates terrain with poisonous fallout, mutating survivors.' },
        { id: 'photon_laser_grid', name: 'Photon Laser Grid', icon: '📡', desc: 'Crosshatched coherent light lasers bisecting combatants.' },
        { id: 'entropy_wave', name: 'Entropy Decay Wave', icon: '💀', desc: 'Accelerates thermodynamic breakdown, crumbling walls and aging foes.' },
        { id: 'hyperbeam_satellite', name: 'Hyperbeam Satellite', icon: '🛸', desc: 'Orbital energy array channeling continuous searing laser column.' },
        { id: 'star_eater_strike', name: 'Star Eater Strike', icon: '🪐', desc: 'Cosmic void siphon devouring planetary crust down to bedrock.' },
        { id: 'vacuum_decay', name: 'Vacuum Decay Catalyst', icon: '🌑', desc: 'Drops quantum vacuum state creating expanding void bubble.' },
        { id: 'blight_strike', name: 'Primordial Blight Strike', icon: '🥀', desc: 'Infects landscape with creeping necrosis and cursed marsh.' },
        { id: 'stellar_flare', name: 'Stellar Coronal Flare', icon: '🔥', desc: 'Scorching planetary flare turning forests and fields into ash.' },
        { id: 'doomsday_clock_strike', name: 'Doomsday Clock Strike', icon: '🕰️', desc: 'Midnight strikes: Catastrophic apocalyptic multi-element detonation.' },
        { id: 'void_collapse_cannon', name: 'Void Collapse Cannon', icon: '🌌', desc: 'Heavy gravitational battery tearing local matter into absolute vacuum.' }
    ],
    nature: [
        ...
        { id: 'blizzard_storm', name: 'Blizzard Gale', icon: '🌨️', desc: 'Violent arctic storm coating terrain in snow and freezing waters.' },
        { id: 'thundercloud_front', name: 'Thundercloud Front', icon: '⛈️', desc: 'Approaching squall line bringing drenching rain and lightning.' },
        { id: 'monsoon_surge', name: 'Monsoon Torrent', icon: '🌧️', desc: 'Sustained tropical downpours filling river basins and lush meadows.' },
        { id: 'mist_fog', name: 'Dense Mist Fog', icon: '🌫️', desc: 'Rolls thick atmospheric fog concealing movements across terrain.' },
        { id: 'wildfire_spread', name: 'Wildfire Spread', icon: '🔥', desc: 'Sparks natural forest canopy fires that race before wind.' },
        { id: 'sand_dune_shift', name: 'Sand Dune Shift', icon: '🏜️', desc: 'Rolling desert wind forming shifting golden sand dunes.' },
        { id: 'geyser_eruption', name: 'Thermal Geyser Eruption', icon: '♨️', desc: 'Pressurized subterranean hot spring blasting scalding steam upward.' },
        { id: 'mudflow_slide', name: 'Mudflow Slide', icon: '🌊', desc: 'Saturates hillside slopes into advancing mud torrents.' },
        { id: 'hailstorm_barrage', name: 'Hailstorm Barrage', icon: '🧊', desc: 'Pelts ground with damaging chunks of compacted ice.' },
        { id: 'supercell_tornado', name: 'Supercell Vortex', icon: '🌪️', desc: 'Rotating mesocyclone funnel sweeping away obstacles.' },
        { id: 'dust_devil_whirl', name: 'Dust Devil Whirl', icon: '🌀', desc: 'Whirling vortex of dust and sand skittering across plains.' },
        { id: 'sinkhole_collapse', name: 'Sinkhole Collapse', icon: '🕳️', desc: 'Sudden subterranean cavern breach swallowing surface into deep water.' },
        { id: 'bioluminescent_bloom', name: 'Bioluminescent Bloom', icon: '🍄', desc: 'Awakens glowing emerald and teal moss across caves and soil.' },
        { id: 'spore_cloud_haze', name: 'Fungal Spore Haze', icon: '🟣', desc: 'Drifting cloud of hallucinogenic spores fertilizing mycelium.' },
        { id: 'frostbite_front', name: 'Frostbite Front', icon: '❄️', desc: 'Flash-freezing cold wave solidifying surface fluids into ice.' },
        { id: 'thermal_spring_burst', name: 'Thermal Spring Burst', icon: '💧', desc: 'Spawns bubbling mineral-rich hot springs.' },
        { id: 'tidal_surge_wave', name: 'Tidal Surge Wave', icon: '🌊', desc: 'Great oceanic surge sweeping coastal beaches and inlets.' },
        { id: 'oasis_spring', name: 'Desert Oasis Spring', icon: '🌴', desc: 'Nurtures life in arid wastes with fresh water pool and greenery.' },
        { id: 'rainbow_blessing', name: 'Rainbow Blessing', icon: '🌈', desc: 'Miraculous prism spanning sky, blessing and healing all creatures.' },
        { id: 'drought_wave', name: 'Scorching Drought Wave', icon: '☀️', desc: 'Evaporates shallow waters and parches green vegetation.' },
        { id: 'magma_surge_fissure', name: 'Magma Surge Fissure', icon: '🌋', desc: 'Opens molten fissure spilling glowing magma rock.' },
        { id: 'lightning_tree', name: 'Lightning Strike Arbor', icon: '⚡', desc: 'Directs focused atmospheric bolt charging the earth.' },
        { id: 'coral_sprout', name: 'Coral Reef Sprout', icon: '🪸', desc: 'Cultivates vibrant marine coral barriers in shallow waters.' },
        { id: 'vine_overgrowth', name: 'Primordial Vine Overgrowth', icon: '🌿', desc: 'Rapidly grows dense thorny brambles and jungle vines.' },
        { id: 'crystal_growth', name: 'Luminous Crystal Growth', icon: '💎', desc: 'Sprouts iridescent crystal formations from mineral veins.' },
        { id: 'glacier_advance', name: 'Glacier Sheet Advance', icon: '🏔️', desc: 'Expands mountain snowpack into thick creeping glacial ice.' },
        { id: 'pollen_wind', name: 'Floral Pollen Wind', icon: '🌸', desc: 'Warm breeze pollinating meadows with vibrant wildflowers.' },
        { id: 'fossil_unearth', name: 'Ancient Fossil Unearth', icon: '🦴', desc: 'Exposes prehistoric petrified fossils and amber stones.' },
        { id: 'spring_thaw', name: 'Spring Solstice Thaw', icon: '🌱', desc: 'Melts winter snow and ice, rejuvenating fertile green soils.' },
        { id: 'geomagnetic_solar_squall', name: 'Geomagnetic Solar Squall', icon: '⚡', desc: 'Solar storm winds inducing crackling electromagnetic particle auroras.' }
    ],
    landscaping: [
        ...
        { id: 'obsidian_block', name: 'Obsidian Block', icon: '⬛', desc: 'Dense volcanic glass block impervious to standard explosions.' },
        { id: 'basalt', name: 'Basalt Crust', icon: '🪨', desc: 'Hardened dark igneous rock formed from cooled basaltic lava.' },
        { id: 'glacial_ice', name: 'Glacial Blue Ice', icon: '🧊', desc: 'Deep compacted blue ice from ancient glacial sheets.' },
        { id: 'crystal_ore', name: 'Prismatic Geode Ore', icon: '💎', desc: 'Subterranean geode filled with sparkling amethyst and quartz.' },
        { id: 'gold_vein', name: 'Rich Gold Vein', icon: '🪙', desc: 'Lustrous precious gold mineral deposit prized by civilizations.' },
        { id: 'aether_rock', name: 'Aether Floating Rock', icon: '🪨', desc: 'Gravity-defying stone floating high above surface terrain.' },
        { id: 'mud', name: 'Wet River Mud', icon: '🟤', desc: 'Soft muddy sediment slowing down foot travel.' },
        { id: 'peat', name: 'Peat Moss Bog', icon: '🌾', desc: 'Dark organic wetland soil rich in preserved botanical matter.' },
        { id: 'mycelium', name: 'Bioluminescent Mycelium', icon: '🍄', desc: 'Underground fungal web glowing with faint purple light.' },
        { id: 'coral_barrier', name: 'Coral Barrier Reef', icon: '🪸', desc: 'Natural ocean barrier supporting thriving marine biomes.' },
        { id: 'dune_quicksand', name: 'Sinking Dune Sand', icon: '⏳', desc: 'Deceptive desert sand that drags walking creatures under.' },
        { id: 'volcanic_cinder', name: 'Volcanic Cinder Ash', icon: '🌋', desc: 'Loose basaltic gravel and volcanic tephra deposits.' },
        { id: 'sulfur_stone', name: 'Yellow Sulfur Deposit', icon: '🟡', desc: 'Sulfuric mineral formations found near geothermal vents.' },
        { id: 'chlorophyll_moss', name: 'Verdant Moss', icon: '🌱', desc: 'Vibrant chlorophyll moss carpet retaining moisture.' },
        { id: 'starfall_dust', name: 'Starfall Stardust Dune', icon: '✨', desc: 'Powdered celestial meteorite dust glimmering in daylight.' },
        { id: 'void_stone', name: 'Dark Matter Void Stone', icon: '🌌', desc: 'Enigmatic stone pulsing with gravitational distortion.' },
        { id: 'ancient_brick', name: 'Ancient Ruin Brick', icon: '🧱', desc: 'Weathered stone masonry from forgotten primordial empires.' },
        { id: 'marble_road', name: 'Imperial Marble Highway', icon: '🏛️', desc: 'Paved white marble highway speeding troop movements.' },
        { id: 'runic_slate', name: 'Runic Inscribed Slate', icon: '📜', desc: 'Mystic slate etched with ancient protective glyphs.' },
        { id: 'crimson_red_sand', name: 'Crimson Martian Sand', icon: '🔴', desc: 'Iron oxide red sand native to alien desert wastes.' },
        { id: 'bamboo_thicket', name: 'Emerald Bamboo Thicket', icon: '🎋', desc: 'Rapidly growing hollow bamboo stalks providing lumber.' },
        { id: 'tundra_permafrost', name: 'Frozen Tundra Soil', icon: '❄️', desc: 'Permanently frozen subsoil resistant to erosion.' },
        { id: 'petrified_grove', name: 'Petrified Stone Forest', icon: '🪵', desc: 'Silicified tree trunks turned to colorful stone agate.' },
        { id: 'luminescent_lichen', name: 'Glowing Cyan Lichen', icon: '🦠', desc: 'Symbiotic organism illuminating subterranean caverns.' },
        { id: 'silver_ore', name: 'Gleaming Silver Ore', icon: '🥈', desc: 'Refined noble metal vein useful for artifacts and tech.' },
        { id: 'meteorite_core', name: 'Searing Meteor Core', icon: '☄️', desc: 'Dense extraterrestrial metal radiating residual heat.' },
        { id: 'prismatic_crystal', name: 'Prismatic Rainbow Crystal', icon: '🔮', desc: 'Multi-faceted crystal refracting sunlight into rainbows.' },
        { id: 'deep_earth_mantle', name: 'Deep Earth Mantle', icon: '🌋', desc: 'Dense semi-molten silicate mantle exposed from below.' },
        { id: 'divine_soil', name: 'Hallowed Celestial Soil', icon: '⭐', desc: 'Soil blessed by deities, yielding abundant bounties.' },
        { id: 'abyssal_chasm', name: 'Bottomless Abyssal Chasm', icon: '🕳️', desc: 'Terrifying oceanic drop plunging into eternal darkness.' }
    ],
    powers: [
        ...
        { id: 'divine_shield', name: 'Divine Aegis Shield', icon: '🛡️', desc: 'Bestows invulnerability, blessed aura, and full health on allies.' },
        { id: 'wrath_of_god', name: 'Wrath of God', icon: '⚡', desc: 'Smite the wicked with apocalyptic lightning inflicting 5000 divine damage.' },
        { id: 'celestial_heal', name: 'Celestial Heal Wave', icon: '💚', desc: 'Radiant wave healing all entities, curing plagues and lifting curses.' },
        { id: 'time_warp_fast', name: 'Time Warp: Fast Forward', icon: '⏩', desc: 'Accelerates universal time flow to 5x speed.' },
        { id: 'time_warp_slow', name: 'Time Warp: Slow Motion', icon: '⏪', desc: 'Slows down universal time flow to 0.5x matrix speed.' },
        { id: 'mass_rejuvenation', name: 'Mass Rejuvenation', icon: '🧒', desc: 'Reverses biological aging, setting all nearby creatures to age 18.' },
        { id: 'teleport_all', name: 'Omni Teleportation', icon: '🌀', desc: 'Gathers all creatures in brush and warps them directly to cursor.' },
        { id: 'peace_treaty_edict', name: 'Imperial Peace Treaty', icon: '🕊️', desc: 'Edict mandating eternal planetary peace between all kingdoms.' },
        { id: 'total_war_edict', name: 'Total War Edict', icon: '⚔️', desc: 'Instigates global total war: every civilization attacks all others!' },
        { id: 'inspire_invention', name: 'Inspire Invention Surge', icon: '💡', desc: 'Sparks scientific renaissance, upgrading kingdom eras and resources.' },
        { id: 'sanctify_ground', name: 'Sanctify Ground', icon: '✨', desc: 'Consecrates brush terrain into holy ground and blessed soil.' },
        { id: 'curse_of_decay', name: 'Curse of Decay', icon: '🍂', desc: 'Causes plant matter and buildings to swiftly decay into ash.' },
        { id: 'gravity_well', name: 'Gravitational Well', icon: '🪐', desc: 'Pulls nearby enemies and debris into a dense gravitational center.' },
        { id: 'levitation_field', name: 'Levitation Field', icon: '🎈', desc: 'Inverts local gravity, causing all units to float into sky.' },
        { id: 'elemental_infusion', name: 'Elemental Infusion', icon: '🔥', desc: 'Infuses creatures with fireproof, cryomancer, or electrocharged traits.' },
        { id: 'clone_creature', name: 'Mitosis Clone Ray', icon: '🧬', desc: 'Creates an identical genetic duplicate of target creature.' },
        { id: 'evolution_surge', name: 'Evolutionary Surge', icon: '🦖', desc: 'Mutates creatures, increasing scale, health pool, and damage.' },
        { id: 'divine_fertility', name: 'Divine Fertility', icon: '👶', desc: 'Triggers instant population boom across nearby civilizations.' },
        { id: 'hero_ascension', name: 'Champion Ascension', icon: '👑', desc: 'Elevates target into legendary Titan Hero with massive stat boosts.' },
        { id: 'crown_monarch', name: 'Crown Grand Monarch', icon: '👑', desc: 'Anoints chosen unit as supreme King with golden royal crown.' },
        { id: 'purify_world', name: 'Purify World', icon: '🌟', desc: 'Global miracle cleansing all radioactive fallout, acid, and fire.' },
        { id: 'mind_control_wave', name: 'Hypnotic Mind Wave', icon: '🧠', desc: 'Subjugates enemy warbands under direct divine thrall.' },
        { id: 'invisibility_cloak', name: 'Stealth Cloak Sphere', icon: '👻', desc: 'Veils selected creatures in translucent ghostly invisibility.' },
        { id: 'berserk_rage', name: 'Berserk War Frenzy', icon: '🩸', desc: 'Sends units into bloodthirsty rage with 2.5x speed and damage.' },
        { id: 'frozen_in_time', name: 'Temporal Stasis Prism', icon: '🧊', desc: 'Encases targets in unbreakable temporal stasis prism.' },
        { id: 'speed_boost_aura', name: 'Hyper Velocity Aura', icon: '💨', desc: 'Permanently doubles movement speed with blazing light trails.' },
        { id: 'resurrection_beacon', name: 'Resurrection Beacon', icon: '🕯️', desc: 'Summons radiant beacon continually reviving fallen warriors.' },
        { id: 'wealth_shower', name: 'Golden Wealth Shower', icon: '💰', desc: 'Showers kingdom with 1000 gold and 500 aether crystals.' },
        { id: 'cosmic_knowledge', name: 'Akashic Enlightenment', icon: '🌌', desc: 'Unlocks Cosmic Space Age technology for all civilizations.' },
        { id: 'apotheosis', name: 'Apotheosis Ascendance', icon: '✨', desc: 'Transforms creature into an immortal godlike cosmic deity.' }
    ],
    creatures: [
        ...
        { id: 'solar_phoenix', name: 'Solar Phoenix', icon: '🦅', desc: 'Radiant fiery firebird born from the heart of collapsing stars.' },
        { id: 'frost_wyrm', name: 'Frost Wyrm', icon: '🐉', desc: 'Glacial serpentine dragon chilling air and breathing frost shards.' },
        { id: 'iron_behemoth', name: 'Iron Behemoth', icon: '🦏', desc: 'Colossal iron-clad quadruped titan causing localized earthquakes.' },
        { id: 'celestial_archon', name: 'Celestial Archon', icon: '👼', desc: 'Transcendent winged guardian channeling blinding divine rays.' },
        { id: 'shadow_stalker', name: 'Shadow Stalker', icon: '👤', desc: 'Deadly phantom assassin slipping invisibly through defenses.' },
        { id: 'deep_leviathan', name: 'Deep Leviathan', icon: '🐋', desc: 'Primordial oceanic titan commanding whirlpools and tidal surges.' },
        { id: 'volcanic_drake', name: 'Volcanic Drake', icon: '🐲', desc: 'Magma-crested drake spitting volatile explosive slag.' },
        { id: 'storm_valkyrie', name: 'Storm Valkyrie', icon: '⚡', desc: 'Electrified maiden of battle hurling crackling thunderbolts.' },
        { id: 'mecha_colossus', name: 'Mecha Colossus', icon: '🤖', desc: 'Heavy bipedal siege mech equipped with twin hyper-lasers.' },
        { id: 'astral_unicorn', name: 'Astral Unicorn', icon: '🦄', desc: 'Benevolent horned steed blessing ground with healing stardust.' },
        { id: 'chronomancer', name: 'Chronomancer', icon: '🧙', desc: 'Spacetime sorcerer warping through space and freezing foes.' },
        { id: 'spectral_knight', name: 'Spectral Knight', icon: '🛡️', desc: 'Ghostly warrior clad in ethereal armor reflecting incoming attacks.' },
        { id: 'sand_reaper', name: 'Sand Reaper', icon: '🦂', desc: 'Arid predator hunting under desert dunes with razor pincers.' },
        { id: 'forest_ancient', name: 'Forest Ancient', icon: '🌲', desc: 'Millennia-old treant titan crushing fortresses with mighty limbs.' },
        { id: 'plague_bringer', name: 'Plague Bringer', icon: '🧟', desc: 'Noxious harbinger spreading corrosive rot and raising undead.' },
        { id: 'crystal_scorpion', name: 'Crystal Scorpion', icon: '💎', desc: 'Armored carapace refracting lasers with venomous tail stinger.' },
        { id: 'thunder_hawk', name: 'Thunder Hawk', icon: '🦅', desc: 'High-altitude bird of prey diving with sonic boom electricity.' },
        { id: 'magma_elemental', name: 'Magma Elemental', icon: '🌋', desc: 'Living sentient molten rock igniting terrain wherever it treads.' },
        { id: 'frost_banshee', name: 'Frost Banshee', icon: '👻', desc: 'Floating spirit whose piercing wail flash-freezes victims.' },
        { id: 'dune_crawler', name: 'Dune Crawler', icon: '🐛', desc: 'Massive armored desert centipede burrowing through sands.' },
        { id: 'void_horror', name: 'Void Horror', icon: '👾', desc: 'Multi-eyed cosmic entity warping reality and firing void beams.' },
        { id: 'sun_warrior', name: 'Sun Warrior', icon: '⚔️', desc: 'Solar-infused champion wielding a blazing solar blade.' },
        { id: 'abyssal_kraken_spawn', name: 'Kraken Spawn', icon: '🦑', desc: 'Deep-sea cephalopod pulling unwary sailors into ocean depths.' },
        { id: 'runic_golem', name: 'Runic Golem', icon: '🗿', desc: 'Ancient stone automaton powered by glowing arcane glyphs.' },
        { id: 'cyber_hound', name: 'Cyber Hound', icon: '🐕', desc: 'Fast bionic scouting hound equipped with targeting laser optic.' },
        { id: 'blood_fiend', name: 'Blood Fiend', icon: '🧛', desc: 'Voracious predatory vampire feasting on defeated adversaries.' },
        { id: 'titan_dreadnought', name: 'Titan Dreadnought', icon: '🚀', desc: 'Colossal floating gunship fortress bristling with heavy artillery.' },
        { id: 'steampunk_airship', name: 'Steampunk Airship', icon: '🎈', desc: 'Twin-propeller dirigible dropping explosive mortar bombs.' },
        { id: 'quantum_mech', name: 'Quantum Mech', icon: '🤖', desc: 'Advanced mech teleporting across battlefield in cyan energy flashes.' },
        { id: 'cosmic_dragon', name: 'Cosmic Dragon', icon: '🐉', desc: 'Supreme stellar dragon breathing prismatic galaxy fire across the world.' }
    ],
    menu: [
        ...
        { id: 'brush_circle_small', name: '1-Tile Needle Brush', icon: '📍', desc: 'Set brush size to fine single-pixel precision.' },
        { id: 'brush_square_medium', name: 'Medium Brush (Size 3)', icon: '🟦', desc: 'Set brush size to 3-tile radius for quick sculpting.' },
        { id: 'brush_diamond_large', name: 'Large Brush (Size 7)', icon: '🔷', desc: 'Set brush size to 7-tile radius for sweeping changes.' },
        { id: 'fill_bucket', name: 'Flood Fill Bucket', icon: '🪣', desc: 'Flood fills connected area of same terrain with green grass.' },
        { id: 'smooth_terrain', name: 'Terrain Smoothing Filter', icon: '🌊', desc: 'Averages and softens harsh terrain elevation jaggedness.' },
        { id: 'noise_generator', name: 'Perlin Noise Generator', icon: '🎲', desc: 'Generates organic Perlin noise fractal patterns.' },
        { id: 'erase_all_fire', name: 'Extinguish All Flames', icon: '🧯', desc: 'Instantly extinguishes all burning tiles across the world.' },
        { id: 'quench_lava', name: 'Quench Magma to Obsidian', icon: '🪨', desc: 'Globally solidifies all molten lava into sturdy obsidian.' },
        { id: 'clear_all_acid', name: 'Neutralize All Acid', icon: '💧', desc: 'Globally cleanses and turns corrosive acid pools into pure water.' },
        { id: 'resurrect_dead', name: 'Global Necro Resurrection', icon: '✝️', desc: 'Miraculously revives all fallen corpses across entire world.' },
        { id: 'clear_debris', name: 'Clear All Skeletons & Ash', icon: '🧹', desc: 'Cleanses all burnt ash, rubble, and dead skeletons from map.' },
        { id: 'biome_temperate_stamp', name: 'Temperate Forest Stamp', icon: '🌲', desc: 'Stamps lush temperate woodland with trees and fertile soil.' },
        { id: 'biome_desert_stamp', name: 'Saharan Desert Stamp', icon: '🏜️', desc: 'Stamps sprawling golden dunes and desert sands.' },
        { id: 'biome_snow_stamp', name: 'Arctic Ice Sheet Stamp', icon: '❄️', desc: 'Stamps freezing polar ice cap with permafrost and snow.' },
        { id: 'biome_volcanic_stamp', name: 'Volcanic Hellscape Stamp', icon: '🌋', desc: 'Stamps molten volcanic caldera with magma rock and basalt.' },
        { id: 'biome_alien_stamp', name: 'Aether Alien Biome Stamp', icon: '🌌', desc: 'Stamps cosmic nebula stardust with glowing crystals.' },
        { id: 'biome_ocean_stamp', name: 'Ocean Trench Stamp', icon: '🌊', desc: 'Stamps deep oceanic trenches filled with coral reefs.' },
        { id: 'stat_viewer', name: 'Ecosystem Diagnostics', icon: '📊', desc: 'Displays comprehensive population, kingdom, and world stats.' },
        { id: 'kingdom_ledger', name: 'Geopolitical Ledger', icon: '📜', desc: 'Opens the Kingdom Diplomacy and Alliance ledger modal.' },
        { id: 'creature_census', name: 'Species Census Monitor', icon: '📋', desc: 'Calculates global census count of all living species.' },
        { id: 'day_speed_slider', name: 'Day Cycle Accelerate', icon: '⏩', desc: 'Toggles between 1x, 2x, 4x, and 8x day-night cycle speed.' },
        { id: 'night_skip', name: 'Skip to Sunrise', icon: '🌅', desc: 'Advances simulation time directly to 8:00 AM bright daylight.' },
        { id: 'toggle_bloom', name: 'Toggle Starlight Bloom', icon: '🌟', desc: 'Toggles glowing celestial bloom post-processing shaders.' },
        { id: 'toggle_vignette', name: 'Toggle Cinematic Vignette', icon: '🎬', desc: 'Toggles vintage CRT vignette border aesthetic.' },
        { id: 'toggle_shadows', name: 'Toggle Dynamic Shadows', icon: '👥', desc: 'Toggles real-time sun/moon terrain drop shadows on/off.' },
        { id: 'screenshot_tool', name: 'Capture High-Res Photo', icon: '📸', desc: 'Takes high-resolution snapshot and initiates instant PNG download.' },
        { id: 'reset_view', name: 'Recenter Cosmic Camera', icon: '🎯', desc: 'Centers camera on origin, resetting zoom and tilt.' },
        { id: 'seed_generator', name: 'Regenerate Universe Seed', icon: '🎲', desc: 'Generates a new universe seed and recreates world terrain.' },
        { id: 'export_history', name: 'Chronicle Lore Export', icon: '💾', desc: 'Exports world history and kingdom events as a JSON file.' },
        { id: 'fps_turbo', name: 'Overclock Physics Engine', icon: '⚡', desc: 'Unlocks 120 FPS high-rate physics tick execution.' }
    ]
};
